...
export const FLOW_REGISTRY: Record<RoomType, Record<number, RoomFlow>> = {
  ...
  PIECE_DRESSER: {
    ...
    [pieceDresserFlowV3.version]: pieceDresserFlowV3,
  },
  PIECE_TABLE: {
  ...
  PIECE_SHOE_CABINET: {
    ...
    [pieceShoeCabinetFlowV3.version]: pieceShoeCabinetFlowV3,
  },
  PIECE_NIGHTSTAND: {
    [pieceNightstandFlow.version]: pieceNightstandFlow,
    [pieceNightstandFlowV2.version]: pieceNightstandFlowV2,
    [pieceNightstandFlowV3.version]: pieceNightstandFlowV3,
  },
  PIECE_BENCH: {
...
export const CURRENT_FLOW_VERSION: Record<RoomType, number> = {
  ...
  // piesele-carcasa pornesc pe v3 (configurator 3D, docs/10); pat/masa/bancuta
  // nu sunt corpuri si raman pe v2
  PIECE_WARDROBE: pieceWardrobeFlowV3.version,
  PIECE_TV_UNIT: pieceTvUnitFlowV3.version,
  PIECE_BOOKCASE: pieceBookcaseFlowV3.version,
  PIECE_DESK: pieceDeskFlowV3.version,
  PIECE_BED: pieceBedFlowV2.version,
  PIECE_DRESSER: pieceDresserFlowV3.version,
  PIECE_TABLE: pieceTableFlowV2.version,
  PIECE_SHOE_CABINET: pieceShoeCabinetFlowV3.version,
  PIECE_NIGHTSTAND: pieceNightstandFlowV3.version,
